 ...
 * @author aluno
 */
public class JanelaServicos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Ativar Contrato");
    ...
    private void panelColorSeleciodado() {
        Color color = new Color(187,187,187);
        
        for (int i = 0; i < jTabbedPane1.getTabCount(); i++) {
            jTabbedPane1.setForegroundAt(i, color);
